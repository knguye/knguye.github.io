...
export default function ContactTW() {
  ...
  return (
    <div className="isolate bg-gray-800 px-6 py-16 lg:px-8">
      <div
      ...
      <div className="mx-auto max-w-2xl text-white text-center">
        <h2 className="text-3xl font-bold tracking-tight text-white  sm:text-4xl">Hit me up!</h2>
        <p className="mt-2 text-lg leading-8 text-gray-100">
          Want to know more about me? Do you think I'd be a good fit for a role, or do you want me to perform stand-up?
        </p>
      </div>
          ...
          <div className="sm:col-span-2">
            ...
            <div className="relative mt-2.5">
              ...
              <input
                ...
                id="phone-number"
                autoComplete="tel"
                className="block w-full rounded-md border-0 px-3.5 py-2 pl-20 text-gray-100 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              />
            </div>
          </div>
          <div className="sm:col-span-2">
